...
public class AgentConversation extends BaseEntity {
    ...
    public void setDifyConversationId(String value) {
        this.difyConversationId = value;
    }
    ...
    public String getLastWorkflowRunId() {
        return lastWorkflowRunId;
    }
    public void setLastWorkflowRunId(String value) {
        this.lastWorkflowRunId = value;
    }
