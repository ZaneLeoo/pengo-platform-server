...
public interface WorkflowMapper {
    ...
    int activateVersion(@Param("definitionId") Long definitionId, @Param("versionId") Long versionId,
            @Param("operator") String operator);
    int insertInstance(WorkflowInstance instance);
    WorkflowInstance selectInstance(Long instanceId);
    WorkflowInstance selectInstanceByBusiness(@Param("businessType") String businessType,
    ...
    int actTask(@Param("taskId") Long taskId, @Param("status") String status,
            @Param("userId") Long userId, @Param("opinion") String opinion);
    int activateNextTask(Long instanceId);
    int cancelWaitingTasks(Long instanceId);
    int finishInstance(@Param("instanceId") Long instanceId, @Param("status") String status,
            @Param("operator") String operator);
    int insertEvent(@Param("instanceId") Long instanceId, @Param("taskId") Long taskId,
            @Param("eventType") String eventType, @Param("userId") Long userId,
