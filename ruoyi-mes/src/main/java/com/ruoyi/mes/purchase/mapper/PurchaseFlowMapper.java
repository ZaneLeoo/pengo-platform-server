...
public interface PurchaseFlowMapper {
    int updateOrderStatus(@Param("id") Long id, @Param("fromStatus") String fromStatus, @Param("toStatus") String toStatus, @Param("operator") String operator);
    int updateReceiptStatus(@Param("id") Long id, @Param("fromStatus") String fromStatus, @Param("toStatus") String toStatus, @Param("operator") String operator);
    int updateInboundStatus(@Param("id") Long id, @Param("fromStatus") String fromStatus, @Param("toStatus") String toStatus, @Param("operator") String operator);
    ...
    int updateReceiptInspectionStatus(@Param("receiptId") Long receiptId, @Param("status") String status, @Param("operator") String operator);
