...
public interface PurchaseFlowMapper {
    ...
    int updateReceiptStatus(
            @Param("id") Long id,
            @Param("fromStatus") String fromStatus,
            @Param("toStatus") String toStatus,
            @Param("operator") String operator);

    int updateInboundStatus(
            @Param("id") Long id,
            @Param("fromStatus") String fromStatus,
            @Param("toStatus") String toStatus,
            @Param("operator") String operator);
    ...
    int increaseOrderReceived(
            @Param("orderLineId") Long orderLineId, @Param("quantity") BigDecimal quantity);

    int increaseOrderQualified(
            @Param("orderLineId") Long orderLineId, @Param("quantity") BigDecimal quantity);

    int increaseOrderInbound(
            @Param("orderLineId") Long orderLineId, @Param("quantity") BigDecimal quantity);
    ...
    int updateReceiptInspectionStatus(
            @Param("receiptId") Long receiptId,
            @Param("status") String status,
            @Param("operator") String operator);

    int increaseReceiptInbound(
            @Param("receiptLineId") Long receiptLineId, @Param("quantity") BigDecimal quantity);
    ...
    List<ReceiptReferenceLine> selectReceiptReferenceLines(
            @Param("orderCode") String orderCode,
            @Param("supplierName") String supplierName,
            @Param("materialCode") String materialCode);

    List<InboundReferenceLine> selectInboundReferenceLines(
