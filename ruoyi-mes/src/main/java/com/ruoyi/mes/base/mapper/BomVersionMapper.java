...
public interface BomVersionMapper {
    ...
    BomVersion selectBomVersionByCode(
            @Param("bomMasterId") Long bomMasterId, @Param("versionCode") String versionCode);

    int resetDefaultFlag(
            @Param("bomMasterId") Long bomMasterId, @Param("excludeId") Long excludeId);
