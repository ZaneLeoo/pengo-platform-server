...
public class BomItem extends BaseEntity {
    ...
    public String getComponentItemSpec() {
        return componentItemSpec;
    }
    public void setComponentItemSpec(String componentItemSpec) {
        this.componentItemSpec = componentItemSpec;
    }
    public String getComponentItemUnit() {
        return componentItemUnit;
    }
    public void setComponentItemUnit(String componentItemUnit) {
        this.componentItemUnit = componentItemUnit;
    }
    ...
    public BigDecimal getFixedLossQty() {
        return fixedLossQty;
    }
    public void setFixedLossQty(BigDecimal fixedLossQty) {
        this.fixedLossQty = fixedLossQty;
    }
    @DecimalMin(value = "0", message = "变动损耗率不能小于0")
    @DecimalMax(value = "100", message = "变动损耗率不能大于100")
    public BigDecimal getChangeLossRate() {
        return changeLossRate;
    }
    public void setChangeLossRate(BigDecimal changeLossRate) {
        this.changeLossRate = changeLossRate;
    }
    ...
    public Integer getMrpExpandFlag() {
        return mrpExpandFlag;
    }
    public void setMrpExpandFlag(Integer mrpExpandFlag) {
        this.mrpExpandFlag = mrpExpandFlag;
    }
    ...
    public Boolean getHasChildBom() {
        return hasChildBom;
    }
    public void setHasChildBom(Boolean hasChildBom) {
        this.hasChildBom = hasChildBom;
    }

    public Long getComponentBomVersionId() {
        return componentBomVersionId;
    }
    public void setComponentBomVersionId(Long componentBomVersionId) {
        this.componentBomVersionId = componentBomVersionId;
    }
}
