...
public interface SysNoticeReadMapper {
     ...
     * @return 结果
     */
    public int insertNoticeReadBatch(
            @Param("userId") Long userId, @Param("noticeIds") Long[] noticeIds);
     ...
     */
    public List<SysNotice> selectNoticeListWithReadStatus(
     ...
     * @return 已读用户列表
     */
    public List<Map<String, Object>> selectReadUsersByNoticeId(
            @Param("noticeId") Long noticeId, @Param("searchValue") String searchValue);
