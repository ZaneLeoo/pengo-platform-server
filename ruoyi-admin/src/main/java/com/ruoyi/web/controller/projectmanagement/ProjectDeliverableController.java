...
public class ProjectDeliverableController extends BaseController {
    ...
    /** 新增交付物。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:workItem:add')")
    ...
    /** 修改交付物。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:workItem:edit')")
    ...
    /** 删除交付物。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:workItem:remove')")
    @DeleteMapping("/{ids}")
