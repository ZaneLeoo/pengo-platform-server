...
public class ProjectWbsController extends BaseController {
    ...
    public ProjectWbsController(IProjectWbsService service, IProjectInfoService projectService) {
    ...
    public AjaxResult get(@PathVariable Long id) {
        ProjectWbsNode node = service.get(id);
        projectService.assertViewable(node.getProjectId(), getUserId());
        return success(node);
    }
