...
public class ProjectCategoryController extends BaseController {
    ...
    /** 查询项目分类列表。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:category:list')")
    @GetMapping("/list")
    ...
    /** 查询项目分类详细。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:category:query')")
    ...
    /** 新增项目分类。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:category:add')")
    ...
    /** 修改项目分类。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:category:edit')")
    ...
    /** 删除项目分类。 */
    // 临时关闭项目管理接口权限校验：@PreAuthorize("@ss.hasPermi('projectManagement:category:remove')")
