...
public class BomAiImportItem {
    ...
    public String getMatchedMaterialSpec() {
        return matchedMaterialSpec;
    }

    public void setMatchedMaterialSpec(String matchedMaterialSpec) {
        this.matchedMaterialSpec = matchedMaterialSpec;
    }

    public String getMatchedMaterialUnit() {
        return matchedMaterialUnit;
    }

    public void setMatchedMaterialUnit(String matchedMaterialUnit) {
        this.matchedMaterialUnit = matchedMaterialUnit;
    }

    public String getFinalItemCode() {
        return finalItemCode;
    }

    public void setFinalItemCode(String finalItemCode) {
        this.finalItemCode = finalItemCode;
    }
