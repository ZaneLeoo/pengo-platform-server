...
public class BomAiImportHeader {
    ...
    public String getFinalParentItemCode() { return finalParentItemCode; }
    public void setFinalParentItemCode(String finalParentItemCode) { this.finalParentItemCode = finalParentItemCode; }
    public String getFinalParentItemName() { return finalParentItemName; }
    public void setFinalParentItemName(String finalParentItemName) { this.finalParentItemName = finalParentItemName; }
    public String getFinalParentItemSpec() { return finalParentItemSpec; }
    public void setFinalParentItemSpec(String finalParentItemSpec) { this.finalParentItemSpec = finalParentItemSpec; }
    public BigDecimal getFinalBaseQty() { return finalBaseQty; }
    public void setFinalBaseQty(BigDecimal finalBaseQty) { this.finalBaseQty = finalBaseQty; }
    public Long getFinalParentMaterialId() { return finalParentMaterialId; }
    public void setFinalParentMaterialId(Long finalParentMaterialId) { this.finalParentMaterialId = finalParentMaterialId; }
}
